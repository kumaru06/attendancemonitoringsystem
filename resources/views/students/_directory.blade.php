            ...
            <table class="min-w-full text-left text-sm">
                <thead>
                    <tr class="text-[11px] font-medium uppercase tracking-wider text-slate-400">
                        ...
                        <th class="px-5 py-3 font-medium">USN/ID Number</th>
                        ...
                        <tr class="text-slate-600 transition hover:bg-slate-50/80">
                            <td class="px-5 py-3.5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <p class="font-medium text-slate-900">{{ $student->full_name }}</p>
                                </div>
                            </td>
                            <td class="px-5 py-3.5 font-mono text-[13px]">{{ $student->student_number }}</td>
                            <td class="px-5 py-3.5">
                                @if ($student->gender)
                            ...
                            <td class="px-5 py-3.5">{{ $student->section?->name }}</td>
                            <td class="px-5 py-3.5">
