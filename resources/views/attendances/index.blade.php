...
@section('content')
    <form method="GET" class="mb-5 grid gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:grid-cols-6">
        <div>
        ...
        <div>
            ...
            <select id="level" name="level" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @foreach ($attendances as $row)
                            <tr>
                                ...
                                <td class="px-5 py-3">{{ $row->student?->section?->level?->label() }}</td>
                                ...
                                <td class="px-5 py-3">{{ $row->recorder?->recorderLabel() }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
